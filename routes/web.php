...
Route::prefix('evento')->name('evento.')->group(function () {
    Route::get('/criar/{continuo?}', 'EventoController@create')->name('criar')->middleware('checkAdministrador');
    Route::post('/criar/{continuo?}', 'EventoController@store')->name('criar')->middleware('checkAdministrador');
